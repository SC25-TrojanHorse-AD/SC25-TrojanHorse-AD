...
unsigned long long getrf_count = 0;
unsigned long long tstrf_count = 0;
unsigned long long gessm_count = 0;
unsigned long long ssssm_count = 0;
...
void pangulu_gstrf(pangulu_gstrf_options *gstrf_options, void **pangulu_handle)
{
    ...
    printf("rank=%d getrf_count=%llu tstrf_count=%llu gessm_count=%llu ssssm_count=%llu\n", rank, getrf_count, tstrf_count, gessm_count, ssssm_count);
