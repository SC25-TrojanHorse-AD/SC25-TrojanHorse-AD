...
unsigned long long kernel_count = 0;
...
void pangulu_gstrf(pangulu_gstrf_options *gstrf_options, void **pangulu_handle)
{
    ...
    printf("#%d kernel_count = %llu time_getrf=%f time_tstrf=%f time_gessm=%f time_ssssm=%f\n", rank, kernel_count, time_getrf, time_tstrf, time_gessm, time_ssssm);
}
