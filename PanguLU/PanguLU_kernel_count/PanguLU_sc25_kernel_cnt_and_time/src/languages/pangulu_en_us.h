...
#define PANGULU_E_HEAP_FULL "[PanguLU Error] The heap is full.\n"
#define PANGULU_E_HEAP_EMPTY "[PanguLU Error] The heap is empty on rank.\n"
...
#define PANGULU_I_HEAP_LEN "[PanguLU Debug] heap.length=" FMT_PANGULU_INT64_T " heap.capacity=" FMT_PANGULU_INT64_T "\n", heap->length, heap->capacity
...
#ifdef METIS
#define PANGULU_I_BASIC_INFO "[PanguLU Info] n=" FMT_PANGULU_INT64_T " nnz=" FMT_PANGULU_EXBLOCK_PTR " nb=" FMT_PANGULU_INT32_T " mpi_process=" FMT_PANGULU_INT32_T " openmp_num_threads=%d METIS:%s\n", n, origin_smatrix->rowpointer[n], nb, size, init_options->nthread, (sizeof(idx_t) == 4) ? ("i32") : ((sizeof(idx_t) == 8) ? ("i64") : ("?"))
#else
#define PANGULU_I_BASIC_INFO "[PanguLU Info] n=" FMT_PANGULU_INT64_T " nnz=" FMT_PANGULU_EXBLOCK_PTR " nb=" FMT_PANGULU_INT32_T " mpi_process=" FMT_PANGULU_INT32_T " openmp_num_threads=%d\n", n, origin_smatrix->rowpointer[n], nb, size, init_options->nthread
#endif
