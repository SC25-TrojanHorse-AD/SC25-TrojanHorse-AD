...
extern float cpu_kernel_time;
extern float cpu_gather_scatter_time;
extern float gpu_kernel_time;
extern struct timeval start;
extern unsigned long long cpu_kernel_count;
extern unsigned long long gpu_kernel_count;
...
#include "dSchCompUdt-2Ddynamic.c"
    ...
    printf("rank=%d cpu_kernel_count=%llu gpu_kernel_count=%llu cpu_kernel_time=%f gpu_kernel_time=%f ScatterTimer=%lf\n", 
        iam, cpu_kernel_count, gpu_kernel_count, cpu_kernel_time, gpu_kernel_time, RemainScatterTimer+LookAheadScatterTimer);
