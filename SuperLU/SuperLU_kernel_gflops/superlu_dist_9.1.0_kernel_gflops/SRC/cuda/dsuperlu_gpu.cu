	...
	SuperLUStat_t *stat)
{
	...
	stat->cPCIeH2D += Remain_lbuf_send_size * sizeof(double) + bigu_send_size * sizeof(double) + RemainBlk * sizeof(Remain_info_t) + mcb * sizeof(Ublock_info_t) + lsub_len * sizeof(int_t) + usub_len * sizeof(int_t);
