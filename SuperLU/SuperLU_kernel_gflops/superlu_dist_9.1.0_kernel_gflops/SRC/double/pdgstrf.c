...
// #endif
    ...
    printf("rank=%d cpu_kernel_count=%llu gpu_kernel_count=%llu cpu_kernel_time=%f gpu_kernel_time=%f cpu_gather_scatter_time=%f\n", 
        iam, cpu_kernel_count, gpu_kernel_count, cpu_kernel_time, gpu_kernel_time, cpu_gather_scatter_time);
